 ...
 * Describe:
 */
public class SignCommonWindow extends PopupWindow implements ISignCallback {
    ...
    public SignCommonWindow(Activity activity) {
        ...
        //载进来View
        mPopView = LayoutInflater.from(BaseApplication.getAppContext()).inflate(R.layout.dialog_sign_common, null);
        //设置内容
